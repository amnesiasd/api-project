        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot find user with id=" + id + ": Error - " + err_2 + ".");
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create user with name - " + user.first_name + " " + user.last_name + ": Error - " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("Cannot delete users " + err_4);
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype["delete"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_5 = _a.sent();
                        throw new Error("Cannot delete users " + err_5);
                    case 5: return [2 /*return*/];
                }
            });
        });
